...
\plotfigure{confusion_matrix.png}{Confusion matrix showing the classification performance for binary hotel rating prediction. True labels are on the y-axis, predicted labels on the x-axis.}{fig:confusion}
...
\plotfigure{roc_curve.png}{ROC curve showing the trade-off between true positive rate and false positive rate at different classification thresholds.}{fig:roc}
...
\plotfigure{training_curves.png}{Training and validation accuracy/loss curves over 20 epochs, showing the learning progression and early stopping behavior.}{fig:training}
...
\plotfigure{model_architecture.png}{Neural network architecture diagram showing the flow from input sequences through embedding, bidirectional GRU, flattening, and final classification layers.}{fig:architecture}
